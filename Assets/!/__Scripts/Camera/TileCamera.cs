...
public class TileCamera : MonoBehaviour
{
    ...
    public void LoadMap()
    {
        //Create the TILE_ACNHOR. All Tiles will have this as their parent.
    ...
    void ShowMap()
    {
        ...
        // Run throught the entire map and instantiate Tiles where necessary
        for (int j = 0; j < H; j++)
        {
            for (int i = 0; i < W; i++)
            {
    ...
    static public void SET_MAP(int x, int y, int tileNum)
    {
