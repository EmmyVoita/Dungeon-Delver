...
public class EmpoweredVisualEffect : MonoBehaviour
{
    ...
    public string empoweredPropertyName = "Empowered";
    ...
    public void Play(bool empowered = false)
    {
        if (vfx == null)
        {
        ...
        {
            effect.SetBool(empoweredPropertyName, empowered);
